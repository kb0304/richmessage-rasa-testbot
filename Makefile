...
action-server:
	python -m rasa_core_sdk.endpoint --actions actions --port 5056

run:
	python -m rasa_core.run -d models/current/dialogue/ -u models/current/nlu  --port 5055 --connector rocketchat --credentials credentials.yml --endpoints endpoints.yml
